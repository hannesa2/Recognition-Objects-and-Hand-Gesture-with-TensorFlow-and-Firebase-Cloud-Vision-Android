...
abstract class BaseCameraGestureFragment : Fragment(), FragmentCompat.OnRequestPermissionsResultCallback {
    private val lock = Any()
    private var runClassifier = false
    private var checkedPermissions = false
    private lateinit var classifier: BaseImageClassifier
    ...
    abstract fun fragmentAutoFitTextureView(): Int
    abstract fun fragmentTextView(): Int

    abstract fun classifierOfFragment(): BaseImageClassifier

    abstract val maxPreviewWidth: Int
    abstract val maxPreviewHeigth: Int
    ...
    abstract fun text2Show(text: String): String

    private fun showToast(text: String) {
        activity?.runOnUiThread {
            textView.text = text2Show(text)
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        texture = view?.findViewById(fragmentAutoFitTextureView())!!
        textView = view?.findViewById(fragmentTextView())!!
        return view
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        try {
            classifier = classifierOfFragment()//ImageClassifier(activity)
        } catch (e: IOException) {
    ...
    private fun setUpCameraOutputs(width: Int, height: Int) {
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                if (maxPreviewHeight > maxPreviewHeigth) {
                    maxPreviewHeight = maxPreviewHeigth
                }
    ...
    private fun classifyFrame() {
        ...
        val bitmap = texture.getBitmap(BaseImageClassifier.DIM_IMG_SIZE_X, BaseImageClassifier.DIM_IMG_SIZE_Y)
